...
# Frontend webapp that will download the Gerber ZIP from the local one-shot server.
frontendUrl = 'https://gerber2png.fablabkerala.in/'
frontendOrigin = 'https://gerber2png.fablabkerala.in'
defaultServerPort = 3210

netlistFilename = 'netlist.ipc'
bomFilename = 'BOM.csv'
positionsFilename = 'PnP_positions.csv'
plotPlan = [
